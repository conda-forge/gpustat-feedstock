...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gpustat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6435&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gpustat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gpustat` can be installed with:

```
conda install gpustat
```

It is possible to list all of the versions of `gpustat` available on your platform with:
